...
class RoleValidationTest extends TestCase
{
    public function testEmailValidation(): void
    {
        ...
        $this->assertTrue(false !== filter_var('test@example.com', FILTER_VALIDATE_EMAIL));
        $this->assertTrue(false !== filter_var('user.name@domain.org', FILTER_VALIDATE_EMAIL));
        $this->assertTrue(false !== filter_var('admin+test@company.de', FILTER_VALIDATE_EMAIL));
